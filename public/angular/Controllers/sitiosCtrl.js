...
angular.module('SitiosCtrl', []).controller('SitiosController', function ($scope) {	
	$scope.sitios = [
		...
		},
		{
			...
			text: 'Reúne a realizadoras, camarógrafas, sonidistas, editoras, guionistas, fotógrafas, productoras, animadoras y preservadoras que participaron en el quehacer documental entre 1970 y 1985.',
			url: 'https://lais.mora.edu.mx/mujeresdocumentalistas/',
			img: 'Catálogo_Mujeres_Documentalistas.jpg',
		},
		{
