	...
	$scope.personas = [
		{
			...
			formacion: "Historia, Comunicación, Antropología",
			produccion: [
		...
		},
		{
			...
			lineasInvestigacion:"",
			formacion: "Ciencias de la comunicación",
			produccion: [
				{ tipo: "Capítulo de libro", text: "Métodos en Acción. Estudios sobre documental e investigación social", url: "https://lais.mora.edu.mx/publicacion/603937d5d96f496022f87e8c", date: '2020' },
				{ tipo: "Artículo", text: "Las salas de cine antes de los palacios. La exhibición cinematoográfica en la ciudad de México hacia finales de los años veinte", url: "https://lais.mora.edu.mx/publicacion/59d7fd02c59e4f661b5fd04d", date: '2013' },
		...
		},
		{
			...
			semblanza: "Lilia García Torres es integrante del LAIS desde 2021 y doctorante en Estudios Latinoamericanos en la Universidad Nacional Autónoma de México. Es corealizadora del documental Trinchera sonora. Voces y Miradas de Radio Venderemos (2017) y realizadora de Polinizadorxs. Resistencia en la Península de Yucatán (2022). En 2020 impulso del Editatón “Mujeres documentalistas a la wiki”, y actualmente coordina la investigación “Mujeres Documentalistas en México (1970-1985)”.",
			lineasInvestigacion:"Producción de imágenes hechas por grupos guerrilleros y documental hecho por mujeres.",
			formacion: "Estudios latinoamericanos",
			produccion: [
				{ tipo: "Capítulo de libro", text: "El cine guerrillero en El Salvador", url: "https://lais.mora.edu.mx/publicacion/673209f6f6143d79cebdbc16", date: '2021' },
